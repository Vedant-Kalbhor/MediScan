...
MODEL_FILENAME = Path(__file__).with_name("best_kidney_model.pth")
...
def load_model(model_path=None, device=None):
    ...
    if model_path is None:
        raise FileNotFoundError("Kidney model weights are missing and HF_MODEL_REPO is not configured.")
